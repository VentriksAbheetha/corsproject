...
export async function APICORSrequest(url, method, authToken){
    ...
    return new Promise((resolve, reject) => {
        ...
        xhr.onload = () => {
            ...
            resolve(url + " " + JSON.parse(xhr.responseText).status);
        };
...
// APICORSrequest(url, method, authToken).then((res)=>{
//     let value = res;
//     console.log(value)
//     return value;
// })

// export const getQAapiResponse = async () => {
//     try {
//         const res = await APICORSrequest(url, method, signinCORSrequest());
//         // console.log(res);
//         return res;
//     } catch (err) {
//         console.log(err);
